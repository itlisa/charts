...
import TrackballControls from 'three-orbitcontrols';
...
function d3threeD(exports) {
  ...
  function applySVGTransform(obj, tstr) {
    ...
    let idx = tstr.indexOf('('), len = tstr.length,
  ...
  function fabVis() {
    ...
    controls = scene.controls = TrackballControls(camera);
...
let $d3g = {};
d3threeD($d3g);
export default transformSVGPathExposed;